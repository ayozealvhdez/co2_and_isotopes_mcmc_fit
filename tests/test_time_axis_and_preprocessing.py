...
The tests protect the time axis used in the paper: midpoints for averaged data,
decimal years, t = decimal_year - 1985.0, and monthly isotope means.
"""
...
def test_monthly_timestamps_are_moved_to_exact_month_midpoint():
    """Place monthly timestamps at the exact month midpoint."""
...
def test_day_and_hour_midpoints_are_frequency_specific():
    """Use frequency-specific midpoint recentering."""
...
def test_recenter_timestamps_dispatches_by_frequency():
    """Dispatch timestamp recentering by data frequency."""
...
def test_decimal_year_accounts_for_leap_years():
    """Convert dates to decimal years with leap-year lengths."""
...
def test_timezero_reference_is_decimal_year_minus_1985():
    """Use t = decimal_year - 1985.0 for the model axis."""
...
def test_delta13c_monthly_means_use_sample_std_or_single_measurement_uncertainty():
    """Average delta13C monthly values and uncertainties."""
...
def test_delta14c_monthly_means_follow_same_rule_as_delta13c():
    """Apply the same monthly averaging rule to delta14C."""
...
def test_delta13c_time_axis_helpers_match_co2_month_midpoint_and_decimal_year():
    """Match isotope and CO2 month-midpoint and decimal-year helpers."""

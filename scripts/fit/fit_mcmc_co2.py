...
error_scale_factor = None  # Multiplicative factor applied to all data uncertainties before fitting; use None to leave uncertainties unchanged
...
print(f"Step 9: Generate corner plot using {N_corner_draws} posterior samples")
...
print(f"Step 11: Save the same {N_draws} posterior samples for uncertainty calculations")

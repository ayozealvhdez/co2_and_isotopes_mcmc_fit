"""
Plot the fitted CO2 series, the posterior median model, the 68% confidence band, and the residuals from a previous MCMC run performed with 'fit_mcmc_co2.py'.

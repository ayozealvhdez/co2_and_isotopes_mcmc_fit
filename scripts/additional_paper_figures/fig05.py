...
ax1.fill_between(month_grid, co2_mlo_p16, co2_mlo_p84, color="r", alpha=0.16, linewidth=0, zorder=1)
ax1.plot(month_grid, co2_mlo_p16, color="r", linewidth=0.45, alpha=0.38, zorder=2)
ax1.plot(month_grid, co2_mlo_p84, color="r", linewidth=0.45, alpha=0.38, zorder=2)
ax1.plot(month_grid, co2_mlo_p50, color="r", linewidth=1.2, alpha=0.48, zorder=3, label="MLO")
ax1.fill_between(month_grid, co2_izo_p16, co2_izo_p84, color="0.45", alpha=0.35, linewidth=0, zorder=2)
ax1.plot(month_grid, co2_izo_p16, color="k", linewidth=0.55, alpha=0.75, zorder=4)
ax1.plot(month_grid, co2_izo_p84, color="k", linewidth=0.55, alpha=0.75, zorder=4)
ax1.plot(month_grid, co2_izo_p50, color="k", linewidth=1.4, zorder=5, label="IZO")
...
ax2.fill_between(month_grid, d13c_mlo_p16, d13c_mlo_p84, color="r", alpha=0.16, linewidth=0, zorder=1)
ax2.plot(month_grid, d13c_mlo_p16, color="r", linewidth=0.45, alpha=0.38, zorder=2)
ax2.plot(month_grid, d13c_mlo_p84, color="r", linewidth=0.45, alpha=0.38, zorder=2)
ax2.plot(month_grid, d13c_mlo_p50, color="r", linewidth=1.2, alpha=0.48, zorder=3, label="MLO")
ax2.fill_between(month_grid, d13c_izo_p16, d13c_izo_p84, color="0.45", alpha=0.35, linewidth=0, zorder=2)
ax2.plot(month_grid, d13c_izo_p16, color="k", linewidth=0.55, alpha=0.75, zorder=4)
ax2.plot(month_grid, d13c_izo_p84, color="k", linewidth=0.55, alpha=0.75, zorder=4)
ax2.plot(month_grid, d13c_izo_p50, color="k", linewidth=1.4, zorder=5, label="IZO")
...
ax3.fill_between(month_grid, d14c_izo_p16, d14c_izo_p84, color="0.45", alpha=0.35, linewidth=0, zorder=2)
ax3.plot(month_grid, d14c_izo_p16, color="k", linewidth=0.55, alpha=0.75, zorder=4)
ax3.plot(month_grid, d14c_izo_p84, color="k", linewidth=0.55, alpha=0.75, zorder=4)
ax3.plot(month_grid, d14c_izo_p50, color="k", linewidth=1.4, zorder=5, label="IZO")

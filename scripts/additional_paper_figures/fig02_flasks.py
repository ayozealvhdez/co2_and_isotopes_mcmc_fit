"""
Plot all CO2 mole fraction and carbon isotope records used in the paper, adding
the IZO CO2 surface-flask monthly measurements to the CO2 panel.

Data:
- IZO: CO2 mole fraction, CO2 surface-flask mole fraction, delta13CO2, and Delta14CO2.
- MLO: CO2 mole fraction and delta13CO2.

The script reads the file 'best_fit_and_residuals.txt' from the selected paper
runs. Only the observed values and uncertainties are used.
...
IZO CO2 flasks are shown as light-gray open squares with error bars.
MLO data are shown as semitransparent red points with error bars.

The result is stored in:
results_and_plots/comparisons/fig02_all_paper_records_with_flasks/fig02_flasks.png
"""
...
plot_dir = comparison_directory(project_root, "fig02_all_paper_records_with_flasks")
os.makedirs(plot_dir, exist_ok=True)

combined_output = os.path.join(plot_dir, "fig02_flasks.png")

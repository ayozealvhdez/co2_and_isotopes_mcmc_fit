...
fig, (ax1, ax2, ax3) = plt.subplots(nrows=3, ncols=1, figsize=(14, 10), sharex=True, constrained_layout=True)
...
ax2.plot(decimal_years, mlo_p50_dlf, color="r", linewidth=1.2, alpha=0.50, zorder=4)
ax2.fill_between(decimal_years, izo_p16_dlf, izo_p84_dlf, color="0.45", alpha=0.30, linewidth=0, zorder=2)
ax2.plot(decimal_years, izo_p50_dlf, color="k", linewidth=1.2, zorder=5)
